...
//centeralized chain config -ethereum -aws
//chainlink ,sepolia,starknet
//testnet vs mainnet
const chainConfig = {
      ...
      try {
        ...
        if (web3auth.connected) {
          ...
          if (user.email) {
            ...
            try {
              // backend connection to create user
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">WasteMoney</span>
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">IIITDM Jalapur</span>
            </div>
          </Link>
        </div>
        {!isMobile && (
